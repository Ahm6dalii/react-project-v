      ...
      <div className="border-b pb-4 mb-4">
        <div className="flex items-center justify-between mb-4">
          <div className="flex items-center space-x-4">
            ...
            <div>
              ...
              <p className="text-sm text-gray-500">
                Rating: {props.rating} {"★".repeat(Math.floor(props.rating))}
          ...
          <div className="text-right">
            ...
            {props.isInCart && (
              <button
                className="btn glass mt-3 text-white btn-sm bg-purple-700 hover:bg-red-700"
                onClick={openModal}
              >
                Remove
              </button>
      ...
      {isModalOpen && (
        ...
        >
          <div className="relative p-4 w-full max-w-md max-h-full ">
            <div className="relative bg-white rounded-lg shadow dark:bg-slate-300 dark:text-black">
              <button
                type="button"
